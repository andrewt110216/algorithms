...
# ONLY WORKS FOR NUMBERS WITH UP TO 15 DIGITS...not sure why...has something
#  to do with ints, floats, double, etc...

debug = False  # Keep false here for external imports
